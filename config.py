...
API_ID = int(getenv("API_ID", 24371796))
API_HASH = getenv("API_HASH", "8121c78f4b8b31e88cc2623d1277338d")
BOT_TOKEN = getenv("BOT_TOKEN", "7074945904:AAEBr2LGuK4C2pCG7N3Y-2AMgwe-nDcqW8E")
OWNER_ID = int(getenv("OWNER_ID", 6076683960))
MONGO_URL = getenv("MONGO_URL", "mongodb+srv://Outlawbots:Zoro@cluster0.huekk.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0")
SUPPORT_GRP = getenv("SUPPORT_GRP", "offchats")
UPDATE_CHNL = getenv("UPDATE_CHNL", "PythonBotz")
OWNER_USERNAME = getenv("OWNER_USERNAME", "illegalCollage")
